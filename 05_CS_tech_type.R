...
#########  Est. for different automation technologies types  #########
######################################################################
...
#
# OUTPUT FILES 
# - DiD_results/spike_definition/spike2_alltechs_ln_dip_CS_att_results.RData
...
#
#   and different automation classification (see the paper for the classifications):
#   * 'aut_rob_ai','automn','robot','ai','ndt'
#
...
source(here::here('AUX_DiD_selector_function.R'))
...
folder_exercise <- 'spike_definition'
...
tech_type_list <- c('aut_rob_ai','automn','robot','ai','ndt')
...
save(export_dt, file = here::here('DiD_results',
                                  folder_exercise,
                                  paste0(spike_type,'_alltechs_',vr,'_CS_att_results.RData')))
