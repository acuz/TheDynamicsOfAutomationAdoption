...
#########  Est. for different spike definitions             ##########
######################################################################
...
#
# OUTPUT FILES 
# - DiD_results/spike_definition/all_spikes_autn_rob_ai_ln_dip_CS_att_results.RData
...
#
#   and different spike definitions (see the paper for details):
#   * 'spike' (absolute),'spike2' (within),'spike3' (between),'spike4' (within/between)
#
...
spike_type_list <- c('spike','spike2','spike3','spike4')
...
save(export_dt, file = here::here('DiD_results',
                                  folder_exercise,
                                  paste0('allspikes_',tech_type,'_',vr,'_CS_att_results.RData')))
