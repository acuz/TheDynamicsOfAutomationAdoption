...
#########  Excluding potential hidden intermediaries        ##########
######################################################################
...
#
# OUTPUT FILES 
# - DiD_results/hidden_intermediation/spike2_autn_rob_ai_ln_dip_CS_att_results.RData
...
#
#   and different sample restriction obtained excluding potentially hidden intermediaries of automation goods
#   * 'Re-exporters exclusion - None', 'Re-exporters exclusion - Ample',
#   * 'Excluding persistent importers', 'Excluding over-sized importers'
#
#   
...
folder_exercise <- 'hidden_intermediation'
